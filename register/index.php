...
<body>
   <form action="./register.php" method="post" id="formRegister" name="enviar">
      <div class="row">
         ...
         <input type="text" name="username" id="username" minlength="4" class="form-control" required>
      </div>
      <div class="row">
         <div class="col-6 form-group">
            <label for="user" class="form-label">Nombre</label>
            <input type="text" name="name" id="name" maxlength="24" class="form-control" required>
         </div>
         <div class="col-6 form-group">
            <label for="surname" class="form-label">Apellidos</label>
            <input type="text" name="surname" id="surname" maxlength="48" class="form-control" required>
         </div>
      </div>
      <div class="row">
      ...
      <div class="row">
         ...
         <input type="date" name="birthdate" id="birthdate" max="2005-06-01" min="1923-06-01" class="form-control" required>
      </div>
      <div class="row">
